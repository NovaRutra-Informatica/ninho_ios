...
resources beneath Ninho, NinhoTests or NinhoUITests does not require regeneration.
"""
...
def project() -> dict:
    ...
    products = {}
    for name in groups:
        suffix, file_type = ("app", "wrapper.application") if name == "Ninho" else ("xctest", "wrapper.cfbundle")
    ...
    for name in groups:
        ...
        settings = {**target_common, "PRODUCT_BUNDLE_IDENTIFIER": {"Ninho": "com.aless.ninho.ios", "NinhoTests": "com.aless.ninho.ios.tests", "NinhoUITests": "com.aless.ninho.ios.uitests"}[name]}
